                        ...
                        <div class="single-step sign-up-step-2">
                            <div class="single-step-inner">
                                ...
                                <div class="sign-up-field">
                                    <input id="f-name" type="text" name="f-name" value="{{ old('f-name') }}" required placeholder="First name">
                                    ...
                                    <input id="l-name" type="text" name="l-name" value="{{ old('l-name') }}" required placeholder="Last name">
