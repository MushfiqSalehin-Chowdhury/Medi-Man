...
<body>
    ...
    <footer>
        ...
        <div class="lower-footer">
            <div class="container">
                <p>&copy;<?php echo date('Y'); ?> All right reserved by MediMan</p>
            </div>
        </div>
    </footer>
                        ...
                        <div class="single-step sign-up-step-2">
                            <div class="single-step-inner">
                                ...
                                <div class="sign-up-field">
                                    <input id="f_name" type="text" name="f_name" value="{{ old('f_name') }}" required placeholder="First name">
                                    ...
                                    <input id="l_name" type="text" name="l_name" value="{{ old('l_name') }}" required placeholder="Last name">
                        ...
                        <div class="single-step sign-up-step-3">
                            <div class="single-step-inner">
                                ...
                                <div class="sign-up-field">
                                    ...
                                    <input id="address" type="text" name="address" value="{{ old('address') }}" placeholder="Address" data-if="doctor">
                                    ...
                                    <input id="profession" type="text" name="profession" value="{{ old('profession') }}" placeholder="Profession" data-if="doctor">
                                    ...
                                    <input id="nid" type="text" name="nid" value="{{ old('nid') }}" required placeholder="NID">
                                    ...
                                    <input id="w-place" type="text" name="w-place" value="{{ old('w-place') }}" placeholder="Working place" data-if="patient">

                                    @if ($errors->has('w-place'))
                                        <span class="help-block">
                                            <strong>{{ $errors->first('w-place') }}</strong>
                                        </span>
                                    @endif

                                    <input id="designation" type="text" name="designation" value="{{ old('designation') }}" placeholder="Designation" data-if="patient">
                                    ...
                                    <input id="birth" type="text" name="birth" value="{{ old('birth') }}" required placeholder="Date of birth">
